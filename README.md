...
It has a familiar look and layout of YouTube — including the header, sidebar, and responsive video grid — all without using any frameworks or JavaScript.

![Image](https://github.com/user-attachments/assets/72a0016e-36b4-46f8-9f83-1521d2bc59a2)
...
- **Sidebar navigation** with clean hover effects.  
- Responsive **video grid** using CSS Grid and Flexbox.  
- Sticky layout — the header and sidebar stay visible while scrolling.
...
### 📱 Responsive Design
- Adapts dynamically to different screen sizes using media queries:
  - **≤ 750 px:** Two-column layout  
  - **751 – 999 px:** Three-column layout  
  - **≥ 1000 px:** Four-column layout  
- Works smoothly on desktop and tablet displays.
...
- **Roboto & Arial** – clean, modern font combination  
